      ...
      <div className="od-container px-4 relative z-10 w-full">
        ...
        <div className="relative mb-20 od-reveal">
          <motion.div
            ...
            className="border border-zinc-800 rounded-3xl"
          >
            <div className="bg-[#09090b] rounded-3xl px-6 py-12 md:px-12 md:py-16 text-center relative overflow-hidden">
              <div className="relative z-10 max-w-4xl mx-auto">
                ...
                <a
                  href="https://wa.me/5531996966686?text=Ol%C3%A1!%20Quero%20entender%20como%20funciona%20a%20consultoria."
                  target="_blank"
          ...
          {values.map((value, index) => {
            ...
            return (
              <motion.div
                ...
                className="od-card od-card-hover border border-[#27272a] rounded-2xl p-8 hover:border-[#3f3f46] transition-all duration-300 group hover:-translate-y-2 relative overflow-hidden"
              >
                <div className="absolute top-0 left-0 w-full h-px bg-zinc-600/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
