...
export default function ContactForm() {
  ...
  return (
    <section id="contato" className="bg-[#09090b] py-24 lg:py-36">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          <div>
            ...
            <h2 className="text-4xl sm:text-5xl font-black tracking-tight text-white leading-[1.05] mb-6">
            ...
            <p className="text-[#b4b4bc] text-base sm:text-lg leading-relaxed mb-10">
              ...
              {[
                ...
                <div key={item.title} className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#b4b4bc] text-sm leading-relaxed">{item.desc}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="mt-10 pt-8 border-t border-zinc-800/60">
              <p className="text-zinc-500 text-xs mb-2">Prefere contato direto?</p>
              <a
                href={`mailto:${COMPANY_EMAIL}`}
                className="text-sm text-[#b4b4bc] hover:text-white transition-colors duration-200"
              >
                {COMPANY_EMAIL}
              </a>
            </div>
          ...
          <div>
            {status === "success" ? (
              <div className="flex flex-col items-center justify-center text-center py-16">
                ...
                <h3 className="text-2xl font-black text-white mb-3">Mensagem enviada!</h3>
                <p className="text-[#b4b4bc] text-sm leading-relaxed max-w-xs">
              ...
              <form onSubmit={handleSubmit} noValidate className="space-y-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    autoComplete="name"
                    className="w-full rounded-xl border bg-zinc-900/60 px-4 py-3.5 text-sm text-zinc-100 placeholder-zinc-600 transition-all duration-200 focus:outline-none focus:ring-2"
                    style={{
                      borderColor: errors.name ? "rgba(239,68,68,0.5)" : "rgba(63,63,70,0.8)",
                      boxShadow: errors.name ? undefined : undefined,
                    }}
                ...
                <div>
                  <label className="block text-xs font-semibold uppercase tracking-widest text-zinc-400 mb-2">
                    Negócio ou segmento <span className="text-violet-400">*</span>
                  </label>
                  <input
                    name="business"
                    type="text"
                    ...
                    className="w-full rounded-xl border bg-zinc-900/60 px-4 py-3.5 text-sm text-zinc-100 placeholder-zinc-600 transition-all duration-200 focus:outline-none"
                    style={{ borderColor: errors.business ? "rgba(239,68,68,0.5)" : "rgba(63,63,70,0.8)" }}
                    onFocus={(e) => { e.currentTarget.style.borderColor = "rgba(139,92,246,0.5)"; e.currentTarget.style.boxShadow = "0 0 0 3px rgba(139,92,246,0.1)" }}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    <label className="block text-xs font-semibold uppercase tracking-widest text-zinc-400 mb-2">
                      WhatsApp <span className="text-violet-400">*</span>
                    </label>
                    <input
                      name="phone"
                      type="tel"
                      ...
                      autoComplete="tel"
                      className="w-full rounded-xl border bg-zinc-900/60 px-4 py-3.5 text-sm text-zinc-100 placeholder-zinc-600 transition-all duration-200 focus:outline-none"
                      style={{ borderColor: errors.phone ? "rgba(239,68,68,0.5)" : "rgba(63,63,70,0.8)" }}
                      onFocus={(e) => { e.currentTarget.style.borderColor = "rgba(139,92,246,0.5)"; e.currentTarget.style.boxShadow = "0 0 0 3px rgba(139,92,246,0.1)" }}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      autoComplete="email"
                      className="w-full rounded-xl border border-zinc-800/80 bg-zinc-900/60 px-4 py-3.5 text-sm text-zinc-100 placeholder-zinc-600 transition-all duration-200 focus:outline-none"
                      onFocus={(e) => { e.currentTarget.style.borderColor = "rgba(139,92,246,0.5)"; e.currentTarget.style.boxShadow = "0 0 0 3px rgba(139,92,246,0.1)" }}
                ...
                <div>
                  <label className="block text-xs font-semibold uppercase tracking-widest text-zinc-400 mb-2">
                    O que você precisa? <span className="text-violet-400">*</span>
                  </label>
                  <textarea
                    name="message"
                    value={form.message}
                    ...
                    className="w-full rounded-xl border bg-zinc-900/60 px-4 py-3.5 text-sm text-zinc-100 placeholder-zinc-600 transition-all duration-200 focus:outline-none resize-none"
                    style={{ borderColor: errors.message ? "rgba(239,68,68,0.5)" : "rgba(63,63,70,0.8)" }}
                    onFocus={(e) => { e.currentTarget.style.borderColor = "rgba(139,92,246,0.5)"; e.currentTarget.style.boxShadow = "0 0 0 3px rgba(139,92,246,0.1)" }}
                ...
                <button
                  ...
                  className="w-full inline-flex items-center justify-center gap-3 px-6 py-4 rounded-xl text-white font-bold text-base transition-all duration-200 hover:opacity-90 active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed"
                  style={{
